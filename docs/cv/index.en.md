...
<div class="cv-toolbar">
  <button class="cv-download-btn" onclick="window.print()">
    <svg class="cv-ico" viewBox="0 0 24 24"><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/></svg>
    Download PDF
  </button>
</div>
...
<div class="cv-hero">
  <div class="cv-hero-main">
    ...
    <div class="cv-contact">
      <a class="cv-contact-item" href="mailto:jimmyhassankite@gmail.com" aria-label="Email jimmyhassankite@gmail.com">
        <svg class="cv-ico" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/></svg>
        jimmyhassankite@gmail.com
      </a>
      <span class="cv-contact-item">
        <svg class="cv-ico" viewBox="0 0 24 24"><path d="M12 .5C5.7.5.5 5.7.5 12c0 5.1 3.3 9.4 7.9 10.9.6.1.8-.3.8-.6v-2c-3.2.7-3.9-1.5-3.9-1.5-.5-1.3-1.3-1.7-1.3-1.7-1.1-.7.1-.7.1-.7 1.2.1 1.8 1.2 1.8 1.2 1.1 1.8 2.8 1.3 3.4 1 .1-.8.4-1.3.7-1.6-2.6-.3-5.3-1.3-5.3-5.7 0-1.3.4-2.3 1.2-3.1-.1-.3-.5-1.5.1-3.1 0 0 1-.3 3.2 1.2a11 11 0 0 1 5.9 0c2.2-1.5 3.2-1.2 3.2-1.2.6 1.6.2 2.8.1 3.1.7.8 1.2 1.8 1.2 3.1 0 4.4-2.7 5.4-5.3 5.7.4.4.8 1.1.8 2.2v3.2c0 .3.2.7.8.6 4.6-1.5 7.9-5.8 7.9-10.9C23.5 5.7 18.3.5 12 .5z"/></svg>
        <a href="https://github.com/Hassankites" target="_blank" rel="noopener">github.com/Hassankites</a>
      </span>
    </div>
  </div>
  <div class="cv-hero-avatar">
    <img src="../../assets/images/avatar.jpg" alt="Jim Xu" class="cv-avatar-img">
  </div>
</div>
...
<div class="cv-card">
  <p class="cv-bio">Computer Science undergraduate at Zhejiang University, focused on agent tools, personal software, and web development, with a growing interest in CG/CV. I value clear problem framing, reliable implementation, and thoughtful iteration.</p>
</div>
...
<div class="cv-card">
  <ul class="cv-tags">
    <li class="cv-tag">Agent Tools</li>
    <li class="cv-tag">Personal Development</li>
    <li class="cv-tag">Web Development</li>
  </ul>
</div>
...
<div class="cv-card">
  <div class="cv-honor">
    <div class="cv-honor-title">Tsinghua University 2024 High School Summer Camp</div>
    <div class="cv-honor-meta">
      <span class="cv-honor-award">Outstanding Camper</span>
      <span class="cv-honor-sep">·</span>
      <span class="cv-honor-time">2024.8</span>
      <span class="cv-honor-sep">·</span>
      <span class="cv-honor-org">Tsinghua University</span>
    </div>
  </div>
</div>
...
<div class="cv-card">
  <p class="cv-placeholder">Building the foundations and practical experience for future research.</p>
</div>
